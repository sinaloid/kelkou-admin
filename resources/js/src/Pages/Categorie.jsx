            ...
            <div className="col mb-3" key={idx}>
              <div className="card">
                <div className="d-flex">
                  ...
                  />
                  <div className="w-100 ps-1 position-relative">
                    <span className="d-block fs-18 text-start">
                      Nom de la catégorie
                    </span>
                    <p className="text-start text-muted">Lorem ipsum ....</p>
                    <div className="d-flex position-absolute" style={{bottom:"6px", right:"2px"}}>
